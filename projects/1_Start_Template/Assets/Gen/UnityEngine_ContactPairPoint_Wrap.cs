...
#pragma warning disable 0219
...
#endif
    public static class UnityEngine_ContactPairPoint_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {

                {
                    ...
                    {
                        var result = new UnityEngine.ContactPairPoint();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ContactPairPoint), result);
                    }
                }
    ...
    // ==================== properties start ====================
        ...
        internal static void G_Position(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.ContactPairPoint)Puerts.Utils.GetSelf((int)data, self);
