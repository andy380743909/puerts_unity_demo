        ...
        internal static void M_CopyToNativeArray(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        Unity.Collections.NativeArray<UnityEngine.ContactPairPoint> arg0 = argobj0 != null ? (Unity.Collections.NativeArray<UnityEngine.ContactPairPoint>)argobj0 : StaticTranslate<Unity.Collections.NativeArray<UnityEngine.ContactPairPoint>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
