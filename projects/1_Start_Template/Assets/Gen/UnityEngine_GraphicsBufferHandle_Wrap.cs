        ...
        internal static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.GraphicsBufferHandle), false, false, v8Value0, ref argobj0, ref argType0))
                    {
                        UnityEngine.GraphicsBufferHandle arg0 = argobj0 != null ? (UnityEngine.GraphicsBufferHandle)argobj0 : StaticTranslate<UnityEngine.GraphicsBufferHandle>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
            ...
            {
                {
                    ...
                    {
                        UnityEngine.GraphicsBufferHandle arg0 = argobj0 != null ? (UnityEngine.GraphicsBufferHandle)argobj0 : StaticTranslate<UnityEngine.GraphicsBufferHandle>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                        UnityEngine.GraphicsBufferHandle arg1 = argobj1 != null ? (UnityEngine.GraphicsBufferHandle)argobj1 : StaticTranslate<UnityEngine.GraphicsBufferHandle>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
