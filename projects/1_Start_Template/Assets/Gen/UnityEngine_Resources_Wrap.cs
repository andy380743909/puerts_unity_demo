...
#pragma warning disable 0219
    ...
    // ==================== methods start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_InstanceIDIsValid(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    ;
                    {
                        ...
                        var result = UnityEngine.Resources.InstanceIDIsValid (arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_InstanceIDsToValidArray(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    {
                        Unity.Collections.NativeArray<int> arg0 = argobj0 != null ? (Unity.Collections.NativeArray<int>)argobj0 : StaticTranslate<Unity.Collections.NativeArray<int>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                        Unity.Collections.NativeArray<bool> arg1 = argobj1 != null ? (Unity.Collections.NativeArray<bool>)argobj1 : StaticTranslate<Unity.Collections.NativeArray<bool>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
